...
class UpdateSubscriptionPlanRequest extends BaseRequest
{
    public function rules(): array
    {
        ...
        return [
            'plan_code' => ['sometimes', 'string', 'max:50', Rule::unique('subscription_plans', 'plan_code')->ignore($uuid, 'uuid')],
            'plan_name' => ['sometimes', 'string', 'max:255', Rule::unique('subscription_plans', 'plan_name')->ignore($uuid, 'uuid')],
            'description' => ['nullable', 'string'],
            'plan_type' => ['sometimes', 'string', 'in:daily,weekly,15_days,monthly,quarterly,half_yearly,yearly,custom'],
