...
class UpdateKitchenRequest extends BaseRequest
{
    public function rules(): array
    {
        $kitchenId = $this->route('kitchen')?->id;

        return [
            'kitchen_code' => ['sometimes', 'string', 'max:50', 'unique:kitchens,kitchen_code,' . $kitchenId],
            'name' => ['sometimes', 'string', 'max:255', 'unique:kitchens,name,' . $kitchenId],
            'description' => ['nullable', 'string', 'max:1000'],
            'kitchen_type' => ['sometimes', 'string', 'in:main_kitchen,central_kitchen,cloud_kitchen,branch_kitchen,future_kitchen'],
