...
@Component({
  ...
  template: `
    <section class="bg-slate-100 py-14 sm:py-20 relative overflow-hidden" aria-label="Subscription plans">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-12 sm:mb-14">
          ...
          <h2 class="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900 mb-3">Subscription Plans</h2>
          <p class="text-slate-600 max-w-lg mx-auto text-sm sm:text-base">Choose a plan that fits your lifestyle. Save more with longer subscriptions.</p>
        </div>
