...
import { BalanceSheet, FinancialYear } from '../../../../core/models/finance/finance.model';
  ...
  template: `
    <div style="animation: fadeIn 0.3s ease-out; max-width: 1280px; margin: 0 auto; padding: 0 24px 60px;">
      <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 4px;">
        ...
        <span class="material-icons" style="font-size: 14px; color: #d1d5db;">chevron_right</span>
        <span style="font-size: 12px; color: #374151; font-weight: 600;">Balance Sheet</span>
      </div>

      <div style="display: flex; align-items: flex-start; justify-content: space-between; margin-bottom: 24px;">
        <div>
          <h1 style="font-size: 24px; font-weight: 800; color: #166534; margin: 8px 0 4px 0;">Balance Sheet</h1>
          <p style="font-size: 13px; color: #9ca3af; margin: 0;">Assets, liabilities, and equity position</p>
        </div>
      ...
      <div *ngIf="report">
        <div style="background: white; border-radius: 14px; border: 1px solid #e5e7eb; overflow: hidden; margin-bottom: 24px;">
          <div style="padding: 20px 24px; border-bottom: 1px solid #e5e7eb;">
            <h2 style="font-size: 18px; font-weight: 800; color: #166534; margin: 0 0 4px 0;">Balance Sheet</h2>
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 24px; padding: 24px;">
            <div>
              <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 16px;">
                <div style="width: 40px; height: 40px; border-radius: 10px; background: #dbeafe; display: flex; align-items: center; justify-content: center;">
                  <span class="material-icons" style="font-size: 20px; color: #1d4ed8;">account_balance</span>
                </div>
                <div>
                  <h3 style="font-size: 16px; font-weight: 700; color: #1d4ed8; margin: 0;">Assets</h3>
                  <p style="font-size: 12px; color: #9ca3af; margin: 0;">Total: {{ formatCurrency(report.total_assets) }}</p>
                </div>
              </div>
              <p *ngIf="report.assets.length === 0" style="font-size: 13px; color: #9ca3af; text-align: center; padding: 16px 0; margin: 0;">No asset entries</p>
              <div *ngIf="report.assets.length > 0" style="border: 1px solid #bfdbfe; border-radius: 12px; overflow: hidden;">
                <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                  <thead>
                    <tr style="background: #eff6ff;">
                      <th style="text-align: left; font-size: 11px; font-weight: 700; color: #1d4ed8; text-transform: uppercase; padding: 8px 16px;">Code</th>
                      <th style="text-align: left; font-size: 11px; font-weight: 700; color: #1d4ed8; text-transform: uppercase; padding: 8px 16px;">Account</th>
                      <th style="text-align: right; font-size: 11px; font-weight: 700; color: #1d4ed8; text-transform: uppercase; padding: 8px 16px;">Amount (₹)</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr *ngFor="let item of report.assets; let i = index" style="border-top: 1px solid #dbeafe;"
                      [style.background]="i % 2 === 0 ? 'transparent' : '#eff6ff'">
                      <td style="padding: 10px 16px;"><span style="font-size: 12px; font-weight: 700; font-family: monospace; color: #1d4ed8;">{{ item.account_code }}</span></td>
                      <td style="padding: 10px 16px; color: #1f2937;">{{ item.account_name }}</td>
                      <td style="padding: 10px 16px; text-align: right; font-weight: 700; color: #1d4ed8;">{{ formatNumber(item.amount) }}</td>
                    </tr>
                  </tbody>
                  <tfoot>
                    <tr style="background: #dbeafe; border-top: 2px solid #93c5fd;">
                      <td colspan="2" style="padding: 12px 16px; font-size: 13px; font-weight: 800; color: #1d4ed8;">Total Assets</td>
                      <td style="padding: 12px 16px; text-align: right; font-size: 13px; font-weight: 800; color: #1d4ed8;">{{ formatNumber(report.total_assets) }}</td>
                    </tr>
                  </tfoot>
                </table>
              </div>
            ...
            <div>
              <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 16px;">
                <div style="width: 40px; height: 40px; border-radius: 10px; background: #fee2e2; display: flex; align-items: center; justify-content: center;">
                  <span class="material-icons" style="font-size: 20px; color: #b91c1c;">receipt_long</span>
                </div>
                <div>
                  <h3 style="font-size: 16px; font-weight: 700; color: #b91c1c; margin: 0;">Liabilities</h3>
                  <p style="font-size: 12px; color: #9ca3af; margin: 0;">Total: {{ formatCurrency(report.total_liabilities) }}</p>
                </div>
              </div>
              <p *ngIf="report.liabilities.length === 0" style="font-size: 13px; color: #9ca3af; text-align: center; padding: 16px 0; margin: 0;">No liability entries</p>
              <div *ngIf="report.liabilities.length > 0" style="border: 1px solid #fecaca; border-radius: 12px; overflow: hidden;">
                <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                  <thead>
                  ...
                  <tbody>
                    <tr *ngFor="let item of report.liabilities; let i = index" style="border-top: 1px solid #fecaca;"
                  ...
                  <tfoot>
                    <tr style="background: #fee2e2; border-top: 2px solid #fca5a5;">
                      <td colspan="2" style="padding: 12px 16px; font-size: 13px; font-weight: 800; color: #b91c1c;">Total Liabilities</td>
                      <td style="padding: 12px 16px; text-align: right; font-size: 13px; font-weight: 800; color: #b91c1c;">{{ formatNumber(report.total_liabilities) }}</td>
                    </tr>
                  </tfoot>
                </table>
              </div>
            ...
            <div>
              <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 16px;">
                <div style="width: 40px; height: 40px; border-radius: 10px; background: #ede9fe; display: flex; align-items: center; justify-content: center;">
                  <span class="material-icons" style="font-size: 20px; color: #7c3aed;">equalizer</span>
                </div>
                <div>
                  <h3 style="font-size: 16px; font-weight: 700; color: #7c3aed; margin: 0;">Equity</h3>
                  <p style="font-size: 12px; color: #9ca3af; margin: 0;">Total: {{ formatCurrency(report.total_equity) }}</p>
                </div>
              </div>
              <p *ngIf="report.equity.length === 0" style="font-size: 13px; color: #9ca3af; text-align: center; padding: 16px 0; margin: 0;">No equity entries</p>
              <div *ngIf="report.equity.length > 0" style="border: 1px solid #ddd6fe; border-radius: 12px; overflow: hidden;">
                <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                  <thead>
                    <tr style="background: #f5f3ff;">
                      <th style="text-align: left; font-size: 11px; font-weight: 700; color: #7c3aed; text-transform: uppercase; padding: 8px 16px;">Code</th>
                      <th style="text-align: left; font-size: 11px; font-weight: 700; color: #7c3aed; text-transform: uppercase; padding: 8px 16px;">Account</th>
                      <th style="text-align: right; font-size: 11px; font-weight: 700; color: #7c3aed; text-transform: uppercase; padding: 8px 16px;">Amount (₹)</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr *ngFor="let item of report.equity; let i = index" style="border-top: 1px solid #ede9fe;"
                      [style.background]="i % 2 === 0 ? 'transparent' : '#f5f3ff'">
                      <td style="padding: 10px 16px;"><span style="font-size: 12px; font-weight: 700; font-family: monospace; color: #7c3aed;">{{ item.account_code }}</span></td>
                      <td style="padding: 10px 16px; color: #1f2937;">{{ item.account_name }}</td>
                      <td style="padding: 10px 16px; text-align: right; font-weight: 700; color: #7c3aed;">{{ formatNumber(item.amount) }}</td>
                    </tr>
                  </tbody>
                  <tfoot>
                    <tr style="background: #ede9fe; border-top: 2px solid #c4b5fd;">
                      <td colspan="2" style="padding: 12px 16px; font-size: 13px; font-weight: 800; color: #7c3aed;">Total Equity</td>
                      <td style="padding: 12px 16px; text-align: right; font-size: 13px; font-weight: 800; color: #7c3aed;">{{ formatNumber(report.total_equity) }}</td>
                    </tr>
                  </tfoot>
                </table>
              </div>
        ...
        <div style="background: white; border-radius: 14px; border: 1px solid #e5e7eb; padding: 24px;">
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; gap: 16px;">
            <div style="background: #eff6ff; border-radius: 12px; padding: 16px; text-align: center;">
              <p style="font-size: 12px; font-weight: 600; color: #1d4ed8; margin: 0 0 4px 0;">Total Assets</p>
              <p style="font-size: 20px; font-weight: 800; color: #1d4ed8; margin: 0;">{{ formatCurrency(report.total_assets) }}</p>
            </div>
            <div style="background: #fef2f2; border-radius: 12px; padding: 16px; text-align: center;">
              <p style="font-size: 12px; font-weight: 600; color: #b91c1c; margin: 0 0 4px 0;">Total Liabilities</p>
              <p style="font-size: 20px; font-weight: 800; color: #b91c1c; margin: 0;">{{ formatCurrency(report.total_liabilities) }}</p>
            </div>
            <div style="background: #f5f3ff; border-radius: 12px; padding: 16px; text-align: center;">
              <p style="font-size: 12px; font-weight: 600; color: #7c3aed; margin: 0 0 4px 0;">Total Equity</p>
              <p style="font-size: 20px; font-weight: 800; color: #7c3aed; margin: 0;">{{ formatCurrency(report.total_equity) }}</p>
            </div>
            <div style="border-radius: 12px; padding: 16px; text-align: center;"
              ...
              <p *ngIf="!report.is_balanced" style="font-size: 11px; margin: 4px 0 0 0; color: #b91c1c;">
                Difference: {{ formatCurrency(report.total_assets - report.total_liabilities - report.total_equity) }}
              </p>
            </div>
          </div>
        </div>
      ...
      <div *ngIf="!report && !generating" style="background: white; border-radius: 14px; border: 1px solid #e5e7eb; text-align: center; padding: 64px 24px;">
        ...
        <p style="font-size: 14px; color: #6b7280; margin: 0;">Select a financial year and click Generate to view the Balance Sheet</p>
      </div>
    </div>
...
export class BalanceSheetComponent implements OnInit {
  ...
  generateReport(): void {
    ...
    this.financeApi.getBalanceSheet(this.selectedYearId, asOfDateStr).subscribe({
      next: (res) => {
