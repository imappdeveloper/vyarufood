  ...
  template: `
    <div *ngIf="loading && !reportData" style="display: flex; align-items: center; justify-content: center; min-height: 60vh;">
      <div style="text-align: center;">
        ...
        <p style="font-size: 13px; color: #9ca3af;">Loading GST report...</p>
      </div>
    </div>
    ...
    <div *ngIf="!loading || reportData" style="animation: fadeIn 0.3s ease-out; max-width: 1280px; margin: 0 auto; padding: 0 24px 60px;">
      <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 4px;">
        ...
        <span class="material-icons" style="font-size: 14px; color: #d1d5db;">chevron_right</span>
        <span style="font-size: 12px; color: #374151; font-weight: 600;">GST Report</span>
      </div>

      <div style="margin-bottom: 24px;">
        <h1 style="font-size: 24px; font-weight: 800; color: #166534; margin: 8px 0 4px 0;">GST Report</h1>
        <p style="font-size: 13px; color: #9ca3af; margin: 0;">Tax breakdown by GST type</p>
      </div>
      ...
      <div *ngIf="reportData" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; margin-bottom: 24px;">
        <div style="background: white; border-radius: 14px; border: 1px solid #e5e7eb; padding: 20px; display: flex; align-items: center; gap: 14px; transition: all 0.2s ease;"
          ...
          <div style="width: 44px; height: 44px; border-radius: 12px; background: #eff6ff; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
            <span class="material-icons" style="font-size: 22px; color: #2563eb;">receipt_long</span>
          </div>
          <div>
            <p style="font-size: 11px; font-weight: 600; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.05em; margin: 0 0 2px 0;">Taxable Amount</p>
            <p style="font-size: 22px; font-weight: 800; color: #2563eb; margin: 0;">{{ formatCurrency(reportData.summary?.total_taxable) }}</p>
          </div>
        </div>
        <div style="background: white; border-radius: 14px; border: 1px solid #e5e7eb; padding: 20px; display: flex; align-items: center; gap: 14px; transition: all 0.2s ease;"
          onmouseover="this.style.boxShadow='0 4px 12px rgba(0,0,0,0.05)';this.style.transform='translateY(-1px)'" onmouseout="this.style.boxShadow='';this.style.transform=''">
          <div style="width: 44px; height: 44px; border-radius: 12px; background: #fffbeb; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
            <span class="material-icons" style="font-size: 22px; color: #d97706;">local_taxi</span>
          </div>
          <div>
            <p style="font-size: 11px; font-weight: 600; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.05em; margin: 0 0 2px 0;">Total Tax</p>
            <p style="font-size: 22px; font-weight: 800; color: #d97706; margin: 0;">{{ formatCurrency(reportData.summary?.total_tax) }}</p>
          </div>
        </div>
        <div style="background: white; border-radius: 14px; border: 1px solid #e5e7eb; padding: 20px; display: flex; align-items: center; gap: 14px; transition: all 0.2s ease;"
          onmouseover="this.style.boxShadow='0 4px 12px rgba(0,0,0,0.05)';this.style.transform='translateY(-1px)'" onmouseout="this.style.boxShadow='';this.style.transform=''">
          <div style="width: 44px; height: 44px; border-radius: 12px; background: #faf5ff; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
            <span class="material-icons" style="font-size: 22px; color: #7c3aed;">payments</span>
          </div>
          <div>
            <p style="font-size: 11px; font-weight: 600; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.05em; margin: 0 0 2px 0;">CGST</p>
            <p style="font-size: 22px; font-weight: 800; color: #7c3aed; margin: 0;">{{ formatCurrency(reportData.summary?.total_cgst) }}</p>
          </div>
        </div>
        <div style="background: white; border-radius: 14px; border: 1px solid #e5e7eb; padding: 20px; display: flex; align-items: center; gap: 14px; transition: all 0.2s ease;"
          onmouseover="this.style.boxShadow='0 4px 12px rgba(0,0,0,0.05)';this.style.transform='translateY(-1px)'" onmouseout="this.style.boxShadow='';this.style.transform=''">
          <div style="width: 44px; height: 44px; border-radius: 12px; background: #eef2ff; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
            <span class="material-icons" style="font-size: 22px; color: #4f46e5;">payments</span>
          </div>
          <div>
            <p style="font-size: 11px; font-weight: 600; color: #9ca3af; text-transform: uppercase; letter-spacing: 0.05em; margin: 0 0 2px 0;">SGST</p>
            <p style="font-size: 22px; font-weight: 800; color: #4f46e5; margin: 0;">{{ formatCurrency(reportData.summary?.total_sgst) }}</p>
          </div>
        </div>
      </div>
      ...
      <div *ngIf="reportData?.data?.length" style="background: white; border-radius: 14px; border: 1px solid #e5e7eb; overflow: hidden; margin-bottom: 16px;">
        <div style="display: flex; align-items: center; justify-content: space-between; padding: 14px 16px; border-bottom: 1px solid #f3f4f6;">
          <h3 style="font-size: 13px; font-weight: 700; color: #374151; margin: 0;">GST Details</h3>
        </div>
          ...
          <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
            <thead>
              <tr style="background: #f9fafb; border-bottom: 1px solid #e5e7eb;">
                ...
                <th style="padding: 10px 12px; text-align: left; font-size: 11px; font-weight: 700; color: #6b7280; text-transform: uppercase; letter-spacing: 0.05em;">GST Type</th>
                <th style="padding: 10px 12px; text-align: right; font-size: 11px; font-weight: 700; color: #6b7280; text-transform: uppercase; letter-spacing: 0.05em;">Taxable Amount</th>
                <th style="padding: 10px 12px; text-align: right; font-size: 11px; font-weight: 700; color: #6b7280; text-transform: uppercase; letter-spacing: 0.05em;">CGST</th>
                <th style="padding: 10px 12px; text-align: right; font-size: 11px; font-weight: 700; color: #6b7280; text-transform: uppercase; letter-spacing: 0.05em;">SGST</th>
                <th style="padding: 10px 12px; text-align: right; font-size: 11px; font-weight: 700; color: #6b7280; text-transform: uppercase; letter-spacing: 0.05em;">IGST</th>
                <th style="padding: 10px 12px; text-align: right; font-size: 11px; font-weight: 700; color: #6b7280; text-transform: uppercase; letter-spacing: 0.05em;">Total Tax</th>
              ...
              <tr *ngFor="let row of reportData.data; let i = index" style="border-bottom: 1px solid #f3f4f6; transition: background 0.1s ease;"
                ...
                <td style="padding: 12px 12px;">
                  <span style="display: inline-flex; align-items: center; padding: 3px 10px; border-radius: 999px; font-size: 12px; font-weight: 600;"
                    [style.background]="gstBadge(row.gst_type).bg" [style.color]="gstBadge(row.gst_type).fg">
                    {{ row.gst_type ?? '—' }}
                  </span>
                </td>
                <td style="padding: 12px 12px; text-align: right; font-weight: 600; color: #2563eb;">{{ formatCurrency(row.taxable_amount) }}</td>
                <td style="padding: 12px 12px; text-align: right; color: #374151;">{{ formatCurrency(row.cgst) }}</td>
                <td style="padding: 12px 12px; text-align: right; color: #374151;">{{ formatCurrency(row.sgst) }}</td>
                <td style="padding: 12px 12px; text-align: right; color: #374151;">{{ formatCurrency(row.igst) }}</td>
                <td style="padding: 12px 12px; text-align: right; font-weight: 600; color: #d97706;">{{ formatCurrency(row.total_tax) }}</td>
                <td style="padding: 12px 16px 12px 12px; text-align: right; font-weight: 700; color: #059669;">{{ formatCurrency(row.total_amount) }}</td>
              </tr>
            </tbody>
          </table>
        </div>
        <div *ngIf="reportData.summary" style="padding: 12px 16px; background: #f9fafb; border-top: 1px solid #e5e7eb; display: flex; flex-wrap: wrap; gap: 24px; font-size: 13px;">
          <span style="color: #6b7280;">Total Taxable: <strong style="color: #2563eb;">{{ formatCurrency(reportData.summary.total_taxable) }}</strong></span>
          <span style="color: #6b7280;">Total Tax: <strong style="color: #d97706;">{{ formatCurrency(reportData.summary.total_tax) }}</strong></span>
          <span style="color: #6b7280;">Total Amount: <strong style="color: #059669;">{{ formatCurrency(reportData.summary.total_amount) }}</strong></span>
        </div>
      </div>
      ...
      <div *ngIf="reportData && !reportData?.data?.length" style="display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 60px 24px;">
        ...
        <h3 style="font-size: 16px; font-weight: 700; color: #166534; margin: 0 0 4px 0;">No GST data found</h3>
      ...
      <app-chart-card
        *ngIf="chartLabels.length && chartValues.length"
        title="Tax by GST Type"
        subtitle="GST distribution overview"
        chartType="donut"
...
export class GstReportComponent implements OnInit {
  ...
  displayedColumns = ['period', 'gst_type', 'taxable_amount', 'cgst', 'sgst', 'igst', 'total_tax', 'total_amount'];
  ...
  gstBadge(type: string): { bg: string; fg: string } {
    switch (type) {
      case 'CGST': return { bg: '#eff6ff', fg: '#1d4ed8' };
      case 'SGST': return { bg: '#eef2ff', fg: '#4338ca' };
      case 'IGST': return { bg: '#faf5ff', fg: '#7c3aed' };
      case 'UTGST': return { bg: '#fffbeb', fg: '#b45309' };
      default: return { bg: '#f9fafb', fg: '#374151' };
    }
  }

  loadReport(): void {
    this.loading = true;
    this.reportApi.getReport('gst', {
  ...
  private buildChartData(): void {
    ...
    this.chartSeries = { series: [{ name: 'Tax', data: this.chartValues }] };
  }
}
